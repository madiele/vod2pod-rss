...
fn get_description(media_element: &MediaObject, item: &Entry) -> Option<String> {
    ...
    const FOOTER: &str = concat!(
        "<br><br>generated by vod-to-podcast ",
        env!("CARGO_PKG_VERSION"),
        " made by Mattia Di Eleuterio (<a href=\"https://github.com/madiele\">madiele</a>). Check out the <a href=\"https://github.com/madiele/VoDToPodcastRSS\">GitHub repository</a>."
    );
